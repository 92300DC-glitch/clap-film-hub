...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'participate.faq.cost.a': 'De 1,50€ HT à 3€ HT par envoi de votre fichier vidéo à un festival selon les tarifs en vigueur.',
    'participate.faq.multiple.q': 'Puis-je soumettre plusieurs films ?',
    'participate.faq.multiple.a': 'Non, c\'est un seul court-métrage par réalisateur.',
    ...
    'participate.faq.screening.a': 'Les films sélectionnés seront projetés lors de la cérémonie officielle le 6 juin 2026 au cinéma Pathé Levallois.',
    ...
    'participate.faq.contact.a': 'Vous pouvez nous contacter via le formulaire de contact ou par email à ptitclap@ville-levallois.fr',
  ...
  en: {
    ...
    'participate.faq.cost.a': 'From €1.50 excl. tax to €3 excl. tax per video file submission to a festival, according to current rates.',
    'participate.faq.multiple.q': 'Can I submit multiple films?',
    'participate.faq.multiple.a': 'No, only one short film per director.',
    ...
    'participate.faq.screening.a': 'Selected films will be screened at the official ceremony on June 6, 2026 at the Pathé Levallois cinema.',
    ...
    'participate.faq.contact.a': 'You can contact us via the contact form or by email at ptitclap@ville-levallois.fr',
