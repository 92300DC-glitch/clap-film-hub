...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'participate.condition.1': 'Court-métrage de fiction, animation ou documentaire',
    'participate.condition.2': 'Durée maximale : 30 minutes générique compris',
    'participate.condition.3': 'Film achevé après le 1er janvier 2024',
    'participate.condition.4': 'Première ou deuxième œuvre du réalisateur',
    'participate.condition.5': 'Sous-titres français obligatoires pour les films non francophones',
    'participate.condition.6': 'Format de projection : DCP ou fichier HD',
  ...
  en: {
    ...
    'participate.condition.1': 'Fiction, animation or documentary short film',
    'participate.condition.2': 'Maximum duration: 30 minutes including credits',
    'participate.condition.3': 'Film completed after January 1st, 2024',
    'participate.condition.4': 'First or second work by the director',
    'participate.condition.5': 'French subtitles required for non-French films',
    'participate.condition.6': 'Screening format: DCP or HD file',
